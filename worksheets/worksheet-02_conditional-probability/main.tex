...
\begin{problem}
  ...
  \begin{enumerate}[(a),itemsep=5em]
    ...
    to 8 or 9?
    \item Diego decides to roll his pair of dice another time. What is the probability that he will get
    a sum of 4 or 7?
...
\begin{problem}
  ...
  \begin{enumerate}[(a)]
    ...
    \vspace{2.75cm} %\dicegamesanswerbox
...
\begin{problem}
  ...
  \begin{enumerate}[(a)]
    ...
    \vspace{5.75cm} %\dicegamesanswerbox
