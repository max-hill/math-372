...
\begin{document}
\subsection*{Syllabus for Math 372: Elementary Probability and Statistics}
Spring 2026 (Jan 12 - May 15)

\Fl{Instructor:} Max Hill
\fl{Office:} Physical Sciences Building 304
\fl{Office Hours:} ?? (or other times by appointment).
...
\begin{center} \begin{minipage}{5.0in}
    \begin{flushleft}
      Midterm 1 \dotfill~Feb 18 or 20 (in class) \\
      Midterm 2 \dotfill~March 23, 25, or 27 (in class) \\
      Final exam \dotfill~???\\
    \end{flushleft}
  \end{minipage}
\end{center}
...
\Fl{Homework:} Homework will be a mix of worksheets, written assignments, and online assignments through
WebAssign.
\begin{itemize}
