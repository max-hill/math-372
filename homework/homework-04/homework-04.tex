...
\begin{problem}[Exercise 2.3.34]
  ...
  \begin{enumerate}[(a)]
    \item How many ways are there to randomly select 5 keyboards for a
    ...
    probability that at least 4 of them will have a mechanical defect?
  \end{enumerate}
\end{problem}
